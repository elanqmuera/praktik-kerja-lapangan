        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
             ...
             <center> <h4 >Lontar Lab Foundation</h4> 
              <h6 class="font-weight-light">Pengajuan Praktik Kerja Lapangan <h6></center>
              <form class="pt-3" method="POST">
                @csrf
                <div class="form-group">
                    <input id="nama_peserta" type="text" class="form-control @error('nama_peserta') is-invalid @enderror" name="nama_peserta" value="{{ old('nama_peserta') }}" required autocomplete="name" autofocus placeholder="Nama Pengajuan">
                    @error('nama_peserta')
                ...
                <div class="form-group">
                    <input id="instansi" type="text" class="form-control @error('instansi') is-invalid @enderror" name="instansi" required autocomplete="instansi" placeholder="Instansi">
                    @error('instansi')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    <input id="jenis_kelamin" type="enum" class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" required autocomplete="jenis_kelamin" placeholder="Jenis Kelamin">
                    @error('jenis_kelamin')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    <input id="jurusan" type="text" class="form-control @error('jurusan') is-invalid @enderror" name="jurusan" required autocomplete="jurusan" placeholder="Jurusan">
                    @error('jurusan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    <input id="semester" type="text" class="form-control @error('semester') is-invalid @enderror" name="semester" required autocomplete="semester" placeholder="Semester">
                    @error('semester')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
